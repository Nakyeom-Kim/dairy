...
웹앱 URL
https://script.google.com/macros/s/AKfycbwn-lkDXk-YMDS2bO4_brpoBmsWOyrekSUEzoComDkt0hset-sN2jYcxNF4xfOEAAM8/exec
...
프롬프트:
메인 화면 오른쪽 상단에 [일기 목록] 버튼을 만들고 이 버튼을 누르면 구글 시트에서 datatime 필드의 내용의 일부를 가져와서 나열하는 기능을 추가해줘. 일기 목록은 별도의 모달 화면을 띄워서 구성하고 날짜를 선택하면 날짜는 메인화면의 날짜 영역에, 해당 일기를 일기 작성 영역에 나타내줘.
